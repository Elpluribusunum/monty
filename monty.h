 ...
 *
 * Description: structure of a doubly linked list node
...
/**
 * struct instruction_s - OP code and its purpose
 * @opcode: the opcode
 * @f: handle the opcode function
 *
 * Description: OP code and its purpose
 * for stack, queues, LIFO, FIFO project
 */
...
/* THE PRIMARY FUNCTIONS OF INTERPRETER */
...
/* SPECIFIC STANDARD LIBRARY OPTIONS */
